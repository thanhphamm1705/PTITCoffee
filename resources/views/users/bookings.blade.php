      ...
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center">
          ...
          <div class="col-md-7 col-sm-12 text-center ftco-animate">
              <h1 class="mb-3 mt-5 bread">ĐƠN CỦA TÔI</h1>
              <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Trang chủ</a></span> <span>Đơn của tôi</span></p>
          </div>
                ...
                <table class="table-dark" style="width: 100%">
                    ...
                    <tbody>
                      ...
                      @if($bookings->count() > 0)
                          ...
                          <tr class="text-center" style="height: 140px">
                              ...
                              @if($booking->status == "Booked")
                                <a class="btn btn-primary" href="{{ route('write.reviews') }}">Review cho chúng mình</a>
                              @else
                                <p>Không có sẵn</p>
                                @endif
                              </td>
                      ...
                      @else
                          ...
                          <p class="alert alert-success">Bạn chưa có đơn nào cả :<</p>
                      @endif
