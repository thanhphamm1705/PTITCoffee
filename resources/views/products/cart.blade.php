      ...
      <section class="ftco-section ftco-cart">
                      ...
                      <table class="table-dark" style="width: 1300px">
                          ...
                          <tbody>
                            ...
                            @else
                                ...
                                <p class="alert alert-success">Bạn chưa có sản phẩm nào trong giỏ</p>
                            @endif
          ...
          <div class="row justify-content-end">
              <div class="col col-lg-3 col-md-6 mt-5 cart-wrap ftco-animate">
                  ...
                  @else
                    <p class="text-center alert alert-success">Bạn không thể thanh toán vì bạn không có sản phẩm nào trong giỏ</p>
                  @endif
              </div>
          </div>
          </div>
