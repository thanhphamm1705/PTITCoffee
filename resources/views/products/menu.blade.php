...
<section class="home-slider owl-carousel">
      ...
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center">
          ...
          <div class="col-md-7 col-sm-12 text-center ftco-animate">
              ...
              <p class="breadcrumbs"><span class="mr-2"><a href="index.html">TRANG CHỦ</a></span> <span>Menu</span></p>
          </div>
  ...
  <section class="ftco-section">
      ...
      <div class="row">
          ...
          <div class="col-md-6">
              <h3 class="mb-5 heading-pricing text-white ftco-animate">Đồ ăn</h3>
          ...
          <div class="col-md-6">
              <h3 class="mb-5 heading-pricing text-white ftco-animate">Đồ uống</h3>
              ...
              <div class="col-lg-12 ftco-animate p-md-5">
                ...
                <div class="col-md-12 nav-link-wrap mb-5">
                  <div class="nav ftco-animate nav-pills justify-content-center" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link" id="v-pills-3-tab" data-toggle="pill" href="#v-pills-3" role="tab" aria-controls="v-pills-3" aria-selected="false">Đồ ăn</a>
                  </div>
                </div>
                            ...
                            <div class="col-md-4 text-center">
                                <div class="menu-wrap">
                                    ...
                                    <div class="text">
                                        ...
                                        <p><a href="{{ route('product.single', $drink->id) }}" class="btn btn-primary btn-outline-primary">Thêm vào giỏ hàng</a></p>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                            ...
                            <div class="col-md-4 text-center">
                                <div class="menu-wrap">
                                    ...
                                    <div class="text">
                                        ...
                                        <p><a href="{{ route('product.single', $dessert->id) }}" class="btn btn-primary btn-outline-primary">Thêm vào giỏ hàng</a></p>
                                    </div>
                                </div>
                            </div>
                        @endforeach
