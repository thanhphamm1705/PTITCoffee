...
Route::get('edit-bookings/{id}', [App\Http\Controllers\Admins\AdminsController::class, 'editBooking'])->name('edit.booking');
Route::post('edit-bookings/{id}', [App\Http\Controllers\Admins\AdminsController::class, 'UpdateBooking'])->name('update.booking');
Route::get('delete-bookings/{id}', [App\Http\Controllers\Admins\AdminsController::class, 'deleteBooking'])->name('delete.booking');
