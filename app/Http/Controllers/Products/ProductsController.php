...
class ProductsController extends Controller
{
    ...
    public function addCart(Request $request, $id) {
        ...
        return Redirect::route('product.single', $id)->with( ['success' => "sản phẩm đã thêm thành công"] );
    }
    ...
    public function deleteProductCart($id) {
        ...
        if($deleteProductCart) {
            return Redirect::route('cart', $id)->with( ['delete' => "sản phẩm đã xóa thành công"] );
        }
    }
    ...
    public function BookTables(Request $request) {
        ...
        if($request->date > date('n/j/Y')) {
            ...
            if($bookTables) {
                return Redirect::route('home')->with( ['booking' => "bạn đặt bàn thành công"] );
            }
        } else {
            return Redirect::route('home')->with( ['date' => "Hãy đặt thời gian trong tương lai"] );
        }
    }
